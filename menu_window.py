...
class MenuWindow:
    ...
    def show(self):
        ...
        main_frame.pack(fill='both', expand=True, padx=25, pady=20)  # Increased padx from 20 to 25
    ...
    def create_learning_section(self, parent):
        ...
        quiz_dropdown.pack(pady=10, padx=15, fill='x')  # Increased padx and added fill='x'
